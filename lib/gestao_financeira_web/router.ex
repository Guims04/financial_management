defmodule GestaoFinanceiraWeb.Router do
  ...
  import GestaoFinanceiraWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {GestaoFinanceiraWeb.Layouts, :root}
  ...
  scope "/", GestaoFinanceiraWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{GestaoFinanceiraWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", GestaoFinanceiraWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{GestaoFinanceiraWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", GestaoFinanceiraWeb do
    ...
    live_session :current_user,
      on_mount: [{GestaoFinanceiraWeb.UserAuth, :mount_current_user}] do
